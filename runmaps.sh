...
um_cfg_ow="$unminedConfigDir/overworld.json"
um_cfg_ow_night="$unminedConfigDir/overworld_night.json"
um_cfg_ow_inh="$unminedConfigDir/overworld_inhabited.json"
um_cfg_nt="$unminedConfigDir/nether.json"
